...
#define GST_OMX_AAC_DEC_INPUT_PORT 0
#define GST_OMX_AAC_DEC_INPUT_PORT_BUFFERSIZE 4096
#define GST_OMX_AAC_DEC_OUTPUT_PORT 1
#define GST_OMX_AAC_DEC_OUTPUT_PORT_BUFFERSIZE 4608
#define GST_OMX_AAC_DEC_OUTBUF_NSAMPLES 1024
